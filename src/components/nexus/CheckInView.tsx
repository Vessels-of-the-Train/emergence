// src/components/nexus/CheckInView.tsx - E-Motion check-in component
import React, { useState } from "react";
import { runEmergenceCheckInAction } from "@/app/emergence-actions";
import { Radar, RadarChart, PolarGrid, PolarAngleAxis, PolarRadiusAxis, ResponsiveContainer } from 'recharts';
import { GENESIS_HISTORY } from "@/lib/emergence/genesisHistory";
import type { ContextMatrix, EmergenceResponse } from "@/lib/emergence/emergenceTypes";
...
export const CheckInView: React.FC<{ onResult?: (res: EmergenceResponse) => void }> = ({ onResult }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await runEmergenceCheckInAction(matrix);
            setResult(response);
